    ...
    <div id="can-comment" class="mb-4">
        <?php if(!is_user_logged_in()) : ?>
            <div class="alert alert-info" role="alert">
                You must be 
                <a href="<?php echo get_option('siteurl'); ?>/wp-login.php?redirect_to=<?php echo urlencode(get_permalink()); ?>" class="text-decoration-none main-color fw-bold">
                    logged in
                </a>
                to post a comment.
            </div>
        <?php else : ?>
            <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
                <div class="d-flex flex-column gap-4">
                    ...
                    <input name="submit" type="submit" id="submit" value="Submit" class="border-0 main-color bg-transparent fw-bold text-start" required/>
